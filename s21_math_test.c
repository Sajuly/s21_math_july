...
START_TEST(s21_cosTEST) {
    ...
    ck_assert_ldouble_eq_tol(s21_cos(11 * s21_P / 17), cos(11 * s21_P / 17), 1e-6);
...
START_TEST(s21_sinTEST) {
    ...
    ck_assert_ldouble_eq_tol(s21_sin(11 * s21_P / 17), sin(11 * s21_P / 17), 1e-6);
...
START_TEST(s21_tanTEST) {
    ...
    ck_assert_ldouble_eq_tol(s21_tan(11 * s21_P / 17), tan(11 * s21_P / 17), 1e-6);
...
START_TEST(s21_powTEST) {
    ...
    ck_assert_ldouble_eq_tol(s21_pow(9.35378, -9.34748), pow(9.35378, -9.34748), 1e-6);
    ck_assert_ldouble_eq_tol(s21_pow(53.5685, -11.39064), pow(53.5685, -11.39064), 1e-6);
    ck_assert_ldouble_nan(s21_pow(-56.346786, 2.5346));
    ck_assert_ldouble_eq_tol(s21_pow(56.346786, 2.5346), pow(56.346786, 2.5346), 1e-6);
}
END_TEST
...
START_TEST(s21_sqrtTEST) {
    ...
    ck_assert_ldouble_eq_tol(s21_sqrt(987565.9874641213656), sqrt(987565.9874641213656), 1e-6);
...
START_TEST(s21_ceilTEST) {
    ...
    ck_assert_ldouble_eq_tol(s21_ceil(1000000000000.2), ceil(1000000000000.2), 1e-6);
    ck_assert_ldouble_eq_tol(s21_ceil(-1), ceil(-1), 1e-6);
    ck_assert_ldouble_eq_tol(s21_ceil(-25.99999999999), ceil(-25.99999999999), 1e-6);
...
//     ck_assert_ldouble_eq_tol(s21_fabs(-10000000000000000000.33333333333559595989898),
...
//     fabs(12589487885888888882.588999898982222222222), 1e-6);
// }
// END_TEST
...
START_TEST(s21_floorTEST) {
    ...
    ck_assert_ldouble_eq_tol(s21_floor(1000000000000.2), floor(1000000000000.2), 1e-6);
    ck_assert_ldouble_eq_tol(s21_floor(-1), floor(-1), 1e-6);
    ck_assert_ldouble_eq_tol(s21_floor(-25.99999999999), floor(-25.99999999999), 1e-6);
...
START_TEST(s21_fmodTEST) {
    ...
    ck_assert_ldouble_eq_tol(s21_fmod(-5.3, 3.3), fmod(-5.3, 3.3), 1e-6);
    ck_assert_ldouble_eq_tol(s21_fmod(9874.785, 15.15), fmod(9874.785, 15.15), 1e-6);
    ck_assert_ldouble_eq_tol(s21_fmod(-9874.785, 15.15), fmod(-9874.785, 15.15), 1e-6);
    ...
    fmod(200000000000000000000.1, 10000000000000000), 1e-6);
    ...
    ck_assert_ldouble_eq_tol(s21_fmod(8989989882, -148989.5989), fmod(8989989882, -148989.5989), 1e-6);
